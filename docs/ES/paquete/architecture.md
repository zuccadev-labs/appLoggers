...
|---|---|---|
| Android (Gradle) | `.aar` via maven-publish | `implementation("com.github.zuccadev-labs.appLoggers:logger-core:<latest-version>")` |
| iOS (KMP puro) | XCFramework | Build con Gradle KMP desde `iosMain` |
| JVM (Gradle) | `.jar` via maven-publish | `implementation("com.github.zuccadev-labs.appLoggers:logger-core:<latest-version>")` |
