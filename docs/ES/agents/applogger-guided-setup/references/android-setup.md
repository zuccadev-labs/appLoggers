...
```kotlin
dependencies {
    implementation("com.github.devzucca.appLoggers:logger-core:v0.1.1-alpha.1")
    implementation("com.github.devzucca.appLoggers:logger-transport-supabase:v0.1.1-alpha.1")

    testImplementation("com.github.devzucca.appLoggers:logger-test:v0.1.1-alpha.1")
}
```
