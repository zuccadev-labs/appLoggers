...
Los ejemplos y flujos estan alineados con la versión actual del SDK (`sdk/gradle.properties → VERSION_NAME`) y CLI (`cli/VERSION`), con la politica actual de iOS KMP-only.
