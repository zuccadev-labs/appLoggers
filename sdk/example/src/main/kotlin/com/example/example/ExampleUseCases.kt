 ...
 */
class ExampleUseCases(private val logger: AppLogger) {
     ...
     */
    private val log = logger.withTag("ExampleUseCases")

    fun exampleWithTag() {
        log.i("Operation started")                          // tag = "ExampleUseCases"
     ...
     */
    companion object {
        val TAG = loggerTag<ExampleUseCases>()  // = "ExampleUseCases"
    }
